...
JOBS = [
    ...
    JobDB(
        ...
        description="Seeking an experienced canteen supervisor for a 600-student university hostel. Must manage 3 daily meals, coordinate with suppliers, oversee 4 kitchen staff, handle inventory and hygiene compliance. Prior large-scale cooking experience required. Verified Shramik Passport preferred. Immediate joining.",
        posted_at=ts(4),
    ),
